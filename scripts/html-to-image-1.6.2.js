...
global.window.htmlToImage = htmlToImage
...
function cloneChildren(nativeNode, clonedNode, filter) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            children = util_1.toArray(((_a = nativeNode.shadowRoot) !== null && _a !== void 0 ? _a : nativeNode).childNodes);
...
function embedImageNode(clonedNode, options) {
    ...
    return Promise.resolve(clonedNode.src)
        ...
        .then(function (data) {
        return util_1.toDataURL(data.blob, util_1.getMimeType(clonedNode.src) || data.contentType);
    })
...
},{"./applyStyleWithOptions":2,"./cloneNode":3,"./createSvgDataURL":5,"./embedImages":6,"./embedWebFonts":8,"./util":11}],11:[function(require,module,exports){
